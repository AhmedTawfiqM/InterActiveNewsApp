...
import at.tasknews.news.MainActivity;
...
public class BusinessFragment extends Fragment {
    ...
    private void ConnectWithAPINews() {

        APIDataNews apiDataNews = retrofit.create(APIDataNews.class);
        apiDataNews.getNews("eg", Statics.BusinessCAT, Statics.KeyNEWSAPI).enqueue(new Callback<JsonObject>() {
            @Override
